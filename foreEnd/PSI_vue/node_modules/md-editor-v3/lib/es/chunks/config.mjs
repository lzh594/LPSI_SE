const a = "md-editor", o = "md-editor-v3", r = "https://at.alicdn.com/t/c/font_2605852_u82y61ve02.js", e = "https://cdnjs.cloudflare.com/ajax/libs", n = `${e}/highlight.js/11.7.0/highlight.min.js`, c = {
...
}, h = `${e}/screenfull.js/5.2.0/screenfull.min.js`, g = [
  "bold",
  "underline",
  "italic",
  "strikeThrough",
  ...
  "catalog",
  "github"
], m = ["markdownTotal", "=", "scrollSwitch"], p = {
  "zh-CN": {
    toolbarTips: {
      bold: "加粗",
      underline: "下划线",
...
}, u = `${e}/mermaid/10.1.0/mermaid.esm.min.mjs`, k = {

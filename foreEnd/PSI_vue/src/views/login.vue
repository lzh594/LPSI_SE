<template>
    <div class="login-wrap">
        <div class="ms-login">
            <div class="ms-title">SmartChain</div>
            <el-form :model="param" :rules="rules" ref="login" class="ms-content">
                <el-divider content-position="center"><span class="divider">请输入用户名和密码</span></el-divider>
                ...
                <el-divider content-position="center"><span class="divider">请选择身份</span></el-divider>
                <el-form-item class="form-item">
                    <el-radio-group style="width: 100%" v-model="param.identity">
                        <span  class="identity-group">
                            <el-radio-button label="用户" border size="large" style="width: 90px;">用 户</el-radio-button>
                            <el-radio-button label="厂商" border size="large">厂 商</el-radio-button>
                        </span>
                    </el-radio-group>
                </el-form-item>
                <span class="login-btn">
                    <el-button round type="primary" @click="submitForm(login)" class="login-button">登 录</el-button>
                    <el-button round color="" type="primary" @click="submitForm(login)" class="login-button">注 册</el-button>
                </span>
            </el-form>
...
.login-wrap {
    ...
    width: 100%;
    height: 100%;
    background-image: url(../assets/img/LightStreamBlue.jpeg);
